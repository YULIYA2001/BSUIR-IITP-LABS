...
::Ship Boat(200, 270);   //создание объекта класса Ship
::Rect Flag(345, 235);   //создание объекта класса Rect
...
{
    Image1->Canvas->Brush->Color=clSkyBlue; //Устанавливаем цвет кисти
