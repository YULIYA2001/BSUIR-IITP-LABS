...
//void Figure :: Rotation(int &x1, int &y1, int &x2, int &y2)
//	{
//		x1 = (int)(newX + (x1 - newX) * cos(0.2) - (y1 - newY) * sin(0.2));
//		y1 = (int)(newY + (x1 - newX) * sin(0.2) + (y1 - newY) * cos(0.2));
//		x2 = (int)(newX + (x2 - newX) * cos(0.2) - (y2 - newY) * sin(0.2));
//		y2 = (int)(newY + (x2 - newX) * sin(0.2) + (y2 - newY) * cos(0.2));
//	}
